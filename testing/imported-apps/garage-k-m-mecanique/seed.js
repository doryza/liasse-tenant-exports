 ...
 * Dossier (Google: address, phone, rating 4.8/25, 15+ years) + PagesJaunes 6221164 (same phone/address) with no hours or services. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage K M Mécanique",
  contact_phone: '514-564-3138',
  business_address: "10034, avenue Plaza, Montréal-Nord (Québec) H1H 4L6",
  ...
  hero_title: J("Plus de 15 ans, avenue Plaza.", "Over 15 years on avenue Plaza."),
  hero_subtitle: J("Noté 4,8 sur 5 par 25 clients sur Google (septembre 2026), en affaires depuis plus de 15 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.8 out of 5 by 25 customers on Google (September 2026), in business for over 15 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage K M Mécanique est un garage de mécanique automobile situé au 10034, avenue Plaza, à Montréal-Nord. Le garage est en affaires depuis plus de 15 ans. Ses clients lui donnent 4,8 sur 5 sur Google (25 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-564-3138.", "Garage K M Mécanique is an auto repair shop at 10034, avenue Plaza in Montréal-Nord. The garage has been in business for over 15 years. Its customers rate it 4.8 out of 5 on Google (25 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-564-3138."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-564-3138.", "A question or an estimate? The fastest way: a call to 514-564-3138."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage K M Mécanique recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-564-3138.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage K M Mécanique, 10034, avenue Plaza, Montréal-Nord (Québec) H1H 4L6.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage K M Mécanique collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-564-3138.\n\nPerson responsible for personal information: [name to be completed], Garage K M Mécanique, 10034, avenue Plaza, Montréal-Nord (Québec) H1H 4L6."),
