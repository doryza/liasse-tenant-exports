 ...
 * Dossier only (Google: address, phone, rating 4.9/16, 5+ years). Welding is in the business name → « Soudure » confirmed; the rest proposed. No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Mécanique et soudure MZ",
  contact_phone: '514-690-2555',
  business_address: "9880, avenue de l’Esplanade, Montréal (Québec) H3L 2X5",
  ...
  hero_title: J("Mécanique et soudure à Montréal.", "Repairs and welding in Montréal."),
  hero_subtitle: J("Noté 4,9 sur 5 par 16 clients sur Google (septembre 2026), en affaires depuis plus de 5 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.9 out of 5 by 16 customers on Google (September 2026), in business for over 5 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Mécanique et soudure MZ est un garage de mécanique automobile situé au 9880, avenue de l’Esplanade, à Montréal. Comme son nom l’indique, il fait aussi de la soudure. Le garage est en affaires depuis plus de 5 ans. Ses clients lui donnent 4,9 sur 5 sur Google (16 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-690-2555.", "Mécanique et soudure MZ is an auto repair shop at 9880, avenue de l’Esplanade in Montréal. As its name says, it also does welding. The garage has been in business for over 5 years. Its customers rate it 4.9 out of 5 on Google (16 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-690-2555."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-690-2555.", "A question or an estimate? The fastest way: a call to 514-690-2555."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nMécanique et soudure MZ recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-690-2555.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Mécanique et soudure MZ, 9880, avenue de l’Esplanade, Montréal (Québec) H3L 2X5.", "DRAFT FOR THE GARAGE TO APPROVE\n\nMécanique et soudure MZ collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-690-2555.\n\nPerson responsible for personal information: [name to be completed], Mécanique et soudure MZ, 9880, avenue de l’Esplanade, Montréal (Québec) H3L 2X5."),
