 ...
 * Dossier only (Google: address, phone, rating 4.4/54, 10+ years). PagesJaunes 7934266 has the same phone and street but lists the business as « Garage O » (Mon–Fri 09:00–17:00) → name conflict, hours NOT used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage 6 24",
  contact_phone: '450-688-8855',
  business_address: "1860, boulevard Curé-Labelle, Laval (Québec) H7T 1L2",
  ...
  hero_title: J("Plus de 10 ans à Laval.", "Over 10 years in Laval."),
  hero_subtitle: J("Noté 4,4 sur 5 par 54 clients sur Google (septembre 2026), en affaires depuis plus de 10 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.4 out of 5 by 54 customers on Google (September 2026), in business for over 10 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage 6 24 est un garage de mécanique automobile situé au 1860, boulevard Curé-Labelle, à Laval. Le garage est en affaires depuis plus de 10 ans. Ses clients lui donnent 4,4 sur 5 sur Google (54 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-688-8855.", "Garage 6 24 is an auto repair shop at 1860, boulevard Curé-Labelle in Laval. The garage has been in business for over 10 years. Its customers rate it 4.4 out of 5 on Google (54 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-688-8855."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-688-8855.", "A question or an estimate? The fastest way: a call to 450-688-8855."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage 6 24 recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-688-8855.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage 6 24, 1860, boulevard Curé-Labelle, Laval (Québec) H7T 1L2.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage 6 24 collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-688-8855.\n\nPerson responsible for personal information: [name to be completed], Garage 6 24, 1860, boulevard Curé-Labelle, Laval (Québec) H7T 1L2."),
