 ...
 * Dossier (Google: address, phone, 7+ years; rating 4.0/12 not quoted; « Open 24 hours » snippet not used) + PagesJaunes 102723693 (same phone and street, postal H1Z 3H2 vs Google H1Z 3C8 → Google kept) with no hours or services. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Frantz Garage",
  contact_phone: '514-381-9892',
  business_address: "9386, boulevard Saint-Michel, Montréal (Québec) H1Z 3C8",
  ...
  hero_title: J("Votre garage, boulevard Saint-Michel.", "Your garage on boulevard Saint-Michel."),
  ...
  about_text: J("Frantz Garage est un garage de mécanique automobile situé au 9386, boulevard Saint-Michel, à Montréal. Le garage est en affaires depuis plus de 7 ans.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-381-9892.", "Frantz Garage is an auto repair shop at 9386, boulevard Saint-Michel in Montréal. The garage has been in business for over 7 years.\n\nTo check the opening hours or have your vehicle looked at, call 514-381-9892."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-381-9892.", "A question or an estimate? The fastest way: a call to 514-381-9892."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nFrantz Garage recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-381-9892.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Frantz Garage, 9386, boulevard Saint-Michel, Montréal (Québec) H1Z 3C8.", "DRAFT FOR THE GARAGE TO APPROVE\n\nFrantz Garage collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-381-9892.\n\nPerson responsible for personal information: [name to be completed], Frantz Garage, 9386, boulevard Saint-Michel, Montréal (Québec) H1Z 3C8."),
