 ...
 * Dossier only (Google: New York garage, address, phone, rating 4.5/430). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "New York Garage",
  contact_phone: '514-884-2528',
  business_address: "2059, avenue Hingston, Montréal (Québec) H4A 2H9",
  ...
  hero_title: J("New York Garage, avenue Hingston.", "New York Garage on avenue Hingston."),
  hero_subtitle: J("Noté 4,5 sur 5 par 430 clients sur Google (septembre 2026). Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.5 out of 5 by 430 customers on Google (September 2026). Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("New York Garage est un garage de mécanique automobile situé au 2059, avenue Hingston, à Montréal. Ses clients lui donnent 4,5 sur 5 sur Google (430 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-884-2528.", "New York Garage is an auto repair shop at 2059, avenue Hingston in Montréal. Its customers rate it 4.5 out of 5 on Google (430 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-884-2528."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-884-2528.", "A question or an estimate? The fastest way: a call to 514-884-2528."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nNew York Garage recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-884-2528.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], New York Garage, 2059, avenue Hingston, Montréal (Québec) H4A 2H9.", "DRAFT FOR THE GARAGE TO APPROVE\n\nNew York Garage collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-884-2528.\n\nPerson responsible for personal information: [name to be completed], New York Garage, 2059, avenue Hingston, Montréal (Québec) H4A 2H9."),
