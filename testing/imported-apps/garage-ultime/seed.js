 ...
 * Dossier only (Google: address, phone, 15+ years; 1 review → rating not quoted). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Ultime",
  contact_phone: '450-818-5130',
  business_address: "30, rue Émilien-Marcoux, local 107, Blainville (Québec) J7C 0B5",
  payment_methods: J("À confirmer — demandez au garage.", "To be confirmed — ask the garage."),
  service_areas: J("Blainville et les environs", "Blainville and nearby"),
  hero_title: J("Plus de 15 ans à Blainville.", "Over 15 years in Blainville."),
  ...
  about_text: J("Garage Ultime est un garage de mécanique automobile situé au 30, rue Émilien-Marcoux, local 107, à Blainville. Le garage est en affaires depuis plus de 15 ans.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-818-5130.", "Garage Ultime is an auto repair shop at 30, rue Émilien-Marcoux, local 107 in Blainville. The garage has been in business for over 15 years.\n\nTo check the opening hours or have your vehicle looked at, call 450-818-5130."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-818-5130.", "A question or an estimate? The fastest way: a call to 450-818-5130."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Ultime recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-818-5130.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Ultime, 30, rue Émilien-Marcoux, local 107, Blainville (Québec) J7C 0B5.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Ultime collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-818-5130.\n\nPerson responsible for personal information: [name to be completed], Garage Ultime, 30, rue Émilien-Marcoux, local 107, Blainville (Québec) J7C 0B5."),
