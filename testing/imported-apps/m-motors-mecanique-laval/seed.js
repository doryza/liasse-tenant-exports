...
const SETTINGS = {
  business_name: "M Motors — Mécanique Laval",
  contact_phone: '263-881-9484',
  business_address: "2295, rue Monterey, Laval (Québec) H7L 3J1",
  ...
  hero_subtitle: J("Garage de mécanique au 2295, rue Monterey, à Laval. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "An auto repair shop at 2295, rue Monterey in Laval. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("M Motors — Mécanique Laval est un garage de mécanique automobile situé au 2295, rue Monterey, à Laval.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 263-881-9484.", "M Motors — Mécanique Laval is an auto repair shop at 2295, rue Monterey in Laval.\n\nTo check the opening hours or have your vehicle looked at, call 263-881-9484."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 263-881-9484.", "A question or an estimate? The fastest way: a call to 263-881-9484."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nM Motors — Mécanique Laval recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 263-881-9484.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], M Motors — Mécanique Laval, 2295, rue Monterey, Laval (Québec) H7L 3J1.", "DRAFT FOR THE GARAGE TO APPROVE\n\nM Motors — Mécanique Laval collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 263-881-9484.\n\nPerson responsible for personal information: [name to be completed], M Motors — Mécanique Laval, 2295, rue Monterey, Laval (Québec) H7L 3J1."),
