 ...
 * Dossier only (Google: address, phone, 7+ years; 3 reviews → rating not quoted). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Le Plus Que Parfait",
  contact_phone: '514-688-3453',
  business_address: "10491, avenue Drapeau, Montréal-Nord (Québec) H1H 0A3",
  ...
  hero_title: J("Garage à Montréal-⁠Nord.", "Garage in Montréal-⁠Nord."),
  ...
  about_text: J("Garage Le Plus Que Parfait est un garage de mécanique automobile situé au 10491, avenue Drapeau, à Montréal-Nord. Le garage est en affaires depuis plus de 7 ans.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-688-3453.", "Garage Le Plus Que Parfait is an auto repair shop at 10491, avenue Drapeau in Montréal-Nord. The garage has been in business for over 7 years.\n\nTo check the opening hours or have your vehicle looked at, call 514-688-3453."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-688-3453.", "A question or an estimate? The fastest way: a call to 514-688-3453."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Le Plus Que Parfait recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-688-3453.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Le Plus Que Parfait, 10491, avenue Drapeau, Montréal-Nord (Québec) H1H 0A3.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Le Plus Que Parfait collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-688-3453.\n\nPerson responsible for personal information: [name to be completed], Garage Le Plus Que Parfait, 10491, avenue Drapeau, Montréal-Nord (Québec) H1H 0A3."),
