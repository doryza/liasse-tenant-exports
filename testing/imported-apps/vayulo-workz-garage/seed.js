 ...
 * Dossier only (Google: VAYULO WORKZ GARAGE, address, phone, rating 5.0/77; Facebook page only). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Vayulo Workz Garage",
  contact_phone: '438-896-7203',
  business_address: "3951A, avenue de Courtrai, Montréal (Québec) H3S 1B8",
  ...
  hero_title: J("Vayulo Workz, avenue de Courtrai.", "Vayulo Workz on avenue de Courtrai."),
  hero_subtitle: J("Noté 5,0 sur 5 par 77 clients sur Google (septembre 2026). Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 5.0 out of 5 by 77 customers on Google (September 2026). Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Vayulo Workz Garage est un garage de mécanique automobile situé au 3951A, avenue de Courtrai, à Montréal. Ses clients lui donnent 5,0 sur 5 sur Google (77 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 438-896-7203.", "Vayulo Workz Garage is an auto repair shop at 3951A, avenue de Courtrai in Montréal. Its customers rate it 5.0 out of 5 on Google (77 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 438-896-7203."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 438-896-7203.", "A question or an estimate? The fastest way: a call to 438-896-7203."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nVayulo Workz Garage recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 438-896-7203.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Vayulo Workz Garage, 3951A, avenue de Courtrai, Montréal (Québec) H3S 1B8.", "DRAFT FOR THE GARAGE TO APPROVE\n\nVayulo Workz Garage collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 438-896-7203.\n\nPerson responsible for personal information: [name to be completed], Vayulo Workz Garage, 3951A, avenue de Courtrai, Montréal (Québec) H3S 1B8."),
