 ...
 * Dossier (Google: address, phone, rating 4.6/229, 5+ years) + PagesJaunes 102084899 (same phone/street, postal H7T 1A6 vs Google H7T 1A7 → Google kept) with no hours or services. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Auto Mécanique Saint-Martin",
  contact_phone: '450-681-5572',
  business_address: "3640, boulevard Saint-Martin Ouest, Laval (Québec) H7T 1A7",
  ...
  hero_title: J("Mécanique, boulevard Saint-⁠Martin.", "Auto repair on boulevard Saint-⁠Martin."),
  hero_subtitle: J("Noté 4,6 sur 5 par 229 clients sur Google (septembre 2026), en affaires depuis plus de 5 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.6 out of 5 by 229 customers on Google (September 2026), in business for over 5 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Auto Mécanique Saint-Martin est un garage de mécanique automobile situé au 3640, boulevard Saint-Martin Ouest, à Laval. Le garage est en affaires depuis plus de 5 ans. Ses clients lui donnent 4,6 sur 5 sur Google (229 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-681-5572.", "Auto Mécanique Saint-Martin is an auto repair shop at 3640, boulevard Saint-Martin Ouest in Laval. The garage has been in business for over 5 years. Its customers rate it 4.6 out of 5 on Google (229 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-681-5572."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-681-5572.", "A question or an estimate? The fastest way: a call to 450-681-5572."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nAuto Mécanique Saint-Martin recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-681-5572.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Auto Mécanique Saint-Martin, 3640, boulevard Saint-Martin Ouest, Laval (Québec) H7T 1A7.", "DRAFT FOR THE GARAGE TO APPROVE\n\nAuto Mécanique Saint-Martin collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-681-5572.\n\nPerson responsible for personal information: [name to be completed], Auto Mécanique Saint-Martin, 3640, boulevard Saint-Martin Ouest, Laval (Québec) H7T 1A7."),
