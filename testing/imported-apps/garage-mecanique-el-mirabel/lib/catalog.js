...
module.exports = [
  ...
  },
  {
    ...
    name: 'Changement de pneus', name_en: 'Tire changes',
    tagline: 'Montage, équilibrage et rotation des pneus pour une meilleure adhérence et une usure uniforme.',
    tagline_en: 'Tire mounting, balancing and rotation for better grip and even wear.',
    body: 'Deux fois par année, c’est un incontournable au Québec : les pneus d’hiver avant le 1er décembre, ceux d’été au printemps. Le changement de pneus comprend le montage, l’équilibrage, qui élimine les vibrations dans le volant, et la rotation, qui fait passer les pneus d’une position à l’autre pour qu’ils s’usent également et durent plus longtemps. C’est aussi le bon moment pour vérifier la pression et l’usure.',
    body_en: 'Twice a year it is a must in Québec: winter tires on before December 1, summer tires back on in the spring. A tire change covers mounting, balancing, which removes vibration in the steering wheel, and rotation, which moves the tires between positions so they wear evenly and last longer. It is also the right moment to check pressure and wear.',
    signs: list('Le passage aux pneus d’hiver ou d’été', 'Vibration dans le volant sur l’autoroute', 'Usure inégale des pneus'),
    signs_en: list('Switching to winter or summer tires', 'Steering-wheel vibration on the highway', 'Uneven tire wear'),
  },
  {
