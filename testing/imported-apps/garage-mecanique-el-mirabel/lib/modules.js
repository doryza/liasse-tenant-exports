...
module.exports = function (lang) {
  ...
  const settingsFields = [
    { name: 'contact_verified', label: pick('Coordonnées confirmées', 'Contact details confirmed'), description: pick('Le téléphone vient de votre fiche 411Garage. Confirmez qu’il est exact.', 'The phone number comes from your 411Garage listing. Confirm it is correct.') },
    { name: 'address_verified', label: pick('Adresse confirmée', 'Address confirmed'), description: pick('L’adresse vient de votre fiche 411Garage. Confirmez qu’elle est exacte.', 'The address comes from your 411Garage listing. Confirm it is correct.') },
    { name: 'hours_verified', label: pick('Heures confirmées', 'Hours confirmed'), description: pick('Les heures viennent de votre fiche 411Garage. Les plages de rendez-vous en découlent.', 'The hours come from your 411Garage listing. Booking times are built from them.') },
