 ...
 * Dossier only (Google: Garage Auto P N V Inc, address, phone, rating 4.7/91, 20+ years). Yellowpages 131634 in the dossier does not carry this phone → not used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Auto P N V",
  contact_phone: '514-691-9771',
  business_address: "7487A, 18e Avenue, Montréal (Québec) H2A 2N4",
  ...
  hero_title: J("Plus de 20 ans à Montréal.", "Over 20 years in Montréal."),
  hero_subtitle: J("Noté 4,7 sur 5 par 91 clients sur Google (septembre 2026), en affaires depuis plus de 20 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.7 out of 5 by 91 customers on Google (September 2026), in business for over 20 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Auto P N V est un garage de mécanique automobile situé au 7487A, 18e Avenue, à Montréal. Le garage est en affaires depuis plus de 20 ans. Ses clients lui donnent 4,7 sur 5 sur Google (91 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-691-9771.", "Garage Auto P N V is an auto repair shop at 7487A, 18e Avenue in Montréal. The garage has been in business for over 20 years. Its customers rate it 4.7 out of 5 on Google (91 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-691-9771."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-691-9771.", "A question or an estimate? The fastest way: a call to 514-691-9771."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Auto P N V recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-691-9771.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Auto P N V, 7487A, 18e Avenue, Montréal (Québec) H2A 2N4.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Auto P N V collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-691-9771.\n\nPerson responsible for personal information: [name to be completed], Garage Auto P N V, 7487A, 18e Avenue, Montréal (Québec) H2A 2N4."),
