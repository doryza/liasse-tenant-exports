 ...
 * Dossier only (Google: address, phone, 7+ years; 4 reviews → rating not quoted). No PagesJaunes page with this phone. Mécanique générale confirmed from the name. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Atelier CC Mécanique Générale",
  contact_phone: '514-601-6267',
  business_address: "3243, chemin d’Oka, Saint-Eustache (Québec) J7P 0A3",
  ...
  hero_title: J("Plus de 7 ans à Saint-⁠Eustache.", "Over 7 years in Saint-⁠Eustache."),
  hero_subtitle: J("En affaires depuis plus de 7 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "In business for over 7 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Atelier CC Mécanique Générale est un garage de mécanique automobile situé au 3243, chemin d’Oka, à Saint-Eustache. Le garage est en affaires depuis plus de 7 ans.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-601-6267.", "Atelier CC Mécanique Générale is an auto repair shop at 3243, chemin d’Oka in Saint-Eustache. The garage has been in business for over 7 years.\n\nTo check the opening hours or have your vehicle looked at, call 514-601-6267."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-601-6267.", "A question or an estimate? The fastest way: a call to 514-601-6267."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nAtelier CC Mécanique Générale recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-601-6267.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Atelier CC Mécanique Générale, 3243, chemin d’Oka, Saint-Eustache (Québec) J7P 0A3.", "DRAFT FOR THE GARAGE TO APPROVE\n\nAtelier CC Mécanique Générale collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-601-6267.\n\nPerson responsible for personal information: [name to be completed], Atelier CC Mécanique Générale, 3243, chemin d’Oka, Saint-Eustache (Québec) J7P 0A3."),
