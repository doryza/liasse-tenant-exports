/**
 * PROPOSED service list — Atelier CC Mécanique Générale has not published its services anywhere we
 ...
 * confirms what the garage offers (Services et prix). Mécanique générale is confirmed: it is the business name.
