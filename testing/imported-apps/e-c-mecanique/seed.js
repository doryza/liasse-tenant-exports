...
const SETTINGS = {
  business_name: "E.C. Mécanique",
  contact_phone: '438-501-4061',
  business_address: "8091, rue Aimé-Guilbault, porte 9, Terrebonne (Québec) J7M 2G1",
  ...
  hero_title: J("Votre mécanicien à Terrebonne.", "Your mechanic in Terrebonne."),
  hero_subtitle: J("Noté 5,0 sur 5 par 14 clients sur Google (septembre 2026). Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 5.0 out of 5 by 14 customers on Google (September 2026). Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("E.C. Mécanique est un atelier de mécanique automobile situé au 8091, rue Aimé-Guilbault, à Terrebonne. Ses clients lui donnent 5,0 sur 5 sur Google (14 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 438-501-4061.", "E.C. Mécanique is an auto repair shop at 8091, rue Aimé-Guilbault in Terrebonne. Its customers rate it 5.0 out of 5 on Google (14 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 438-501-4061."),
  contact_intro: J("Le plus rapide : un coup de fil au 438-501-4061.", "The fastest way: a call to 438-501-4061."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nE.C. Mécanique recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 438-501-4061.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], E.C. Mécanique, 8091, rue Aimé-Guilbault, porte 9, Terrebonne (Québec) J7M 2G1.", "DRAFT FOR THE GARAGE TO APPROVE\n\nE.C. Mécanique collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 438-501-4061.\n\nPerson responsible for personal information: [name to be completed], E.C. Mécanique, 8091, rue Aimé-Guilbault, porte 9, Terrebonne (Québec) J7M 2G1."),
