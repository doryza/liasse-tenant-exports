 ...
 * Dossier only (Google: Garage gp mécanique plus inc, address, phone; 6 reviews → rating not quoted). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage GP Mécanique Plus",
  contact_phone: '514-325-5314',
  business_address: "5348, rue de Castille, Montréal-Nord (Québec) H1G 3E4",
  ...
  hero_title: J("GP Mécanique Plus, rue de Castille.", "GP Mécanique Plus on rue de Castille."),
  hero_subtitle: J("Garage de mécanique au 5348, rue de Castille, à Montréal-Nord. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "An auto repair shop at 5348, rue de Castille in Montréal-Nord. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage GP Mécanique Plus est un garage de mécanique automobile situé au 5348, rue de Castille, à Montréal-Nord.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-325-5314.", "Garage GP Mécanique Plus is an auto repair shop at 5348, rue de Castille in Montréal-Nord.\n\nTo check the opening hours or have your vehicle looked at, call 514-325-5314."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-325-5314.", "A question or an estimate? The fastest way: a call to 514-325-5314."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage GP Mécanique Plus recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-325-5314.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage GP Mécanique Plus, 5348, rue de Castille, Montréal-Nord (Québec) H1G 3E4.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage GP Mécanique Plus collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-325-5314.\n\nPerson responsible for personal information: [name to be completed], Garage GP Mécanique Plus, 5348, rue de Castille, Montréal-Nord (Québec) H1G 3E4."),
