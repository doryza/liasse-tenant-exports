 ...
 * Dossier (Google: address, phone, rating 4.4/47, 15+ years, « Closes 9 p.m. » on a Thursday) vs PagesJaunes 6782120 (same phone and street) hours Mon–Fri 09:00–19:00 → CONFLICT on closing time: hours not used. No services listed. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Centre Auto Michel & Jimmy",
  contact_phone: '514-270-5331',
  business_address: "5791, boulevard Saint-Laurent, Montréal (Québec) H2T 1S9",
  ...
  hero_title: J("Votre garage, boulevard Saint-Laurent.", "Your garage on boulevard Saint-Laurent."),
  hero_subtitle: J("Noté 4,4 sur 5 par 47 clients sur Google (septembre 2026), en affaires depuis plus de 15 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.4 out of 5 by 47 customers on Google (September 2026), in business for over 15 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Centre Auto Michel & Jimmy est un garage de mécanique automobile situé au 5791, boulevard Saint-Laurent, à Montréal. Le garage est en affaires depuis plus de 15 ans. Ses clients lui donnent 4,4 sur 5 sur Google (47 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-270-5331.", "Centre Auto Michel & Jimmy is an auto repair shop at 5791, boulevard Saint-Laurent in Montréal. The garage has been in business for over 15 years. Its customers rate it 4.4 out of 5 on Google (47 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-270-5331."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-270-5331.", "A question or an estimate? The fastest way: a call to 514-270-5331."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nCentre Auto Michel & Jimmy recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-270-5331.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Centre Auto Michel & Jimmy, 5791, boulevard Saint-Laurent, Montréal (Québec) H2T 1S9.", "DRAFT FOR THE GARAGE TO APPROVE\n\nCentre Auto Michel & Jimmy collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-270-5331.\n\nPerson responsible for personal information: [name to be completed], Centre Auto Michel & Jimmy, 5791, boulevard Saint-Laurent, Montréal (Québec) H2T 1S9."),
