 ...
 * Dossier only (Google: V.M Auto inc., address, phone, rating 4.9/280, 10+ years; promo graphic red/white/black). No PagesJaunes page: draft-to-confirm.
...
const SETTINGS = {
  business_name: "V.M Auto",
  contact_phone: '514-903-7111',
  business_address: "7325, avenue Mountain Sights, Montréal (Québec) H4P 2A7",
  ...
  hero_title: J("Votre garage à Montréal.", "Your Montréal garage."),
  hero_subtitle: J("Noté 4,9 sur 5 par 280 clients sur Google (septembre 2026), en affaires depuis plus de 10 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.9 out of 5 by 280 customers on Google (September 2026), in business for over 10 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("V.M Auto est un garage de mécanique automobile situé au 7325, avenue Mountain Sights, à Montréal. Le garage est en affaires depuis plus de 10 ans. Ses clients lui donnent 4,9 sur 5 sur Google (280 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-903-7111.", "V.M Auto is an auto repair shop at 7325, avenue Mountain Sights in Montréal. The garage has been in business for over 10 years. Its customers rate it 4.9 out of 5 on Google (280 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-903-7111."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-903-7111.", "A question or an estimate? The fastest way: a call to 514-903-7111."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nV.M Auto recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-903-7111.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], V.M Auto, 7325, avenue Mountain Sights, Montréal (Québec) H4P 2A7.", "DRAFT FOR THE GARAGE TO APPROVE\n\nV.M Auto collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-903-7111.\n\nPerson responsible for personal information: [name to be completed], V.M Auto, 7325, avenue Mountain Sights, Montréal (Québec) H4P 2A7."),
