 ...
 * Dossier only (Google: address, phone, category « Mechanic»; 1 review → rating not quoted). PagesJaunes link in dossier is another business (Pneus et Mécanique L.E.). Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Mécanique et Pneu 1500",
  contact_phone: '514-651-6585',
  business_address: "673, boulevard des Laurentides, Laval (Québec) H7G 2V8",
  ...
  hero_title: J("Votre garage à Laval.", "Your Laval garage."),
  hero_subtitle: J("Garage de mécanique au 673, boulevard des Laurentides, à Laval. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "An auto repair shop at 673, boulevard des Laurentides in Laval. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Mécanique et Pneu 1500 est un garage de mécanique automobile situé au 673, boulevard des Laurentides, à Laval.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-651-6585.", "Mécanique et Pneu 1500 is an auto repair shop at 673, boulevard des Laurentides in Laval.\n\nTo check the opening hours or have your vehicle looked at, call 514-651-6585."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-651-6585.", "A question or an estimate? The fastest way: a call to 514-651-6585."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nMécanique et Pneu 1500 recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-651-6585.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Mécanique et Pneu 1500, 673, boulevard des Laurentides, Laval (Québec) H7G 2V8.", "DRAFT FOR THE GARAGE TO APPROVE\n\nMécanique et Pneu 1500 collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-651-6585.\n\nPerson responsible for personal information: [name to be completed], Mécanique et Pneu 1500, 673, boulevard des Laurentides, Laval (Québec) H7G 2V8."),
