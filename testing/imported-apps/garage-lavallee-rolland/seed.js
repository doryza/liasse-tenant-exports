 ...
 * Dossier (Google: Garage Lavallee Rolland, address, phone, 15+ years; 3 reviews → rating not quoted) + PagesJaunes 7867987 « Garage Lavallée » (same phone, same street) with no hours or services (accent taken from it). garagelavallee.com is a Granby garage (other phone) → not used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Lavallée Rolland",
  contact_phone: '450-478-1811',
  business_address: "5650, chemin Gauthier, Terrebonne (Québec) J7M 1R5",
  ...
  hero_title: J("Plus de 15 ans à Terrebonne.", "Over 15 years in Terrebonne."),
  hero_subtitle: J("En affaires depuis plus de 15 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "In business for over 15 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Lavallée Rolland est un garage de mécanique automobile situé au 5650, chemin Gauthier, à Terrebonne. Le garage est en affaires depuis plus de 15 ans.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-478-1811.", "Garage Lavallée Rolland is an auto repair shop at 5650, chemin Gauthier in Terrebonne. The garage has been in business for over 15 years.\n\nTo check the opening hours or have your vehicle looked at, call 450-478-1811."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-478-1811.", "A question or an estimate? The fastest way: a call to 450-478-1811."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Lavallée Rolland recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-478-1811.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Lavallée Rolland, 5650, chemin Gauthier, Terrebonne (Québec) J7M 1R5.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Lavallée Rolland collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-478-1811.\n\nPerson responsible for personal information: [name to be completed], Garage Lavallée Rolland, 5650, chemin Gauthier, Terrebonne (Québec) J7M 1R5."),
