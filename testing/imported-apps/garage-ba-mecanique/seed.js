 ...
 * Dossier only (Google: GARAGE BA MÉCANIQUE, address, phone; 6 reviews → rating not quoted; no years attribute; Facebook handle « garage.ab.autorepairs » not used). No PagesJaunes page with this phone. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage BA Mécanique",
  contact_phone: '438-870-2624',
  business_address: "2005A, rue Lippmann, garages 4 et 5, Laval (Québec) H7S 1P7",
  ...
  hero_title: J("Mécanique à Laval.", "Auto repair in Laval."),
  hero_subtitle: J("Garage de mécanique au 2005A, rue Lippmann, garages 4 et 5, à Laval. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "An auto repair shop at 2005A, rue Lippmann, garages 4 et 5 in Laval. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage BA Mécanique est un garage de mécanique automobile situé au 2005A, rue Lippmann, garages 4 et 5, à Laval.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 438-870-2624.", "Garage BA Mécanique is an auto repair shop at 2005A, rue Lippmann, garages 4 et 5 in Laval.\n\nTo check the opening hours or have your vehicle looked at, call 438-870-2624."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 438-870-2624.", "A question or an estimate? The fastest way: a call to 438-870-2624."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage BA Mécanique recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 438-870-2624.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage BA Mécanique, 2005A, rue Lippmann, garages 4 et 5, Laval (Québec) H7S 1P7.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage BA Mécanique collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 438-870-2624.\n\nPerson responsible for personal information: [name to be completed], Garage BA Mécanique, 2005A, rue Lippmann, garages 4 et 5, Laval (Québec) H7S 1P7."),
