 ...
 * Dossier (Google: address, phone, rating 4.6/49, 15+ years) + PagesJaunes 668784 (same phone and street) with no hours or services. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage 4 Saisons",
  contact_phone: '514-728-6621',
  business_address: "7920, 18e Avenue, Montréal (Québec) H1Z 3R8",
  ...
  hero_title: J("Votre garage, 18e Avenue.", "Your garage on 18e Avenue."),
  hero_subtitle: J("Noté 4,6 sur 5 par 49 clients sur Google (septembre 2026), en affaires depuis plus de 15 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.6 out of 5 by 49 customers on Google (September 2026), in business for over 15 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage 4 Saisons est un garage de mécanique automobile situé au 7920, 18e Avenue, à Montréal. Le garage est en affaires depuis plus de 15 ans. Ses clients lui donnent 4,6 sur 5 sur Google (49 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-728-6621.", "Garage 4 Saisons is an auto repair shop at 7920, 18e Avenue in Montréal. The garage has been in business for over 15 years. Its customers rate it 4.6 out of 5 on Google (49 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-728-6621."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-728-6621.", "A question or an estimate? The fastest way: a call to 514-728-6621."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage 4 Saisons recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-728-6621.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage 4 Saisons, 7920, 18e Avenue, Montréal (Québec) H1Z 3R8.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage 4 Saisons collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-728-6621.\n\nPerson responsible for personal information: [name to be completed], Garage 4 Saisons, 7920, 18e Avenue, Montréal (Québec) H1Z 3R8."),
