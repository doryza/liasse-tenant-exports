 ...
 * Dossier (Google: Jean-Marie Auto Enr, address, phone, rating 4.7/98, 15+ years; GJMA shield on the doors NOT reproduced). PagesJaunes 6680912 has the same phone but ANOTHER address (4548, rue Saint-Denis) → conflict, nothing used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Jean-Marie Auto enr.",
  contact_phone: '514-844-8179',
  business_address: "7143, rue Saint-André, Montréal (Québec) H2R 1V4",
  ...
  hero_title: J("Votre garage, rue Saint-⁠André.", "Your garage on rue Saint-⁠André."),
  hero_subtitle: J("Noté 4,7 sur 5 par 98 clients sur Google (septembre 2026), en affaires depuis plus de 15 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.7 out of 5 by 98 customers on Google (September 2026), in business for over 15 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Jean-Marie Auto enr. est un garage de mécanique automobile situé au 7143, rue Saint-André, à Montréal. Le garage est en affaires depuis plus de 15 ans. Ses clients lui donnent 4,7 sur 5 sur Google (98 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-844-8179.", "Jean-Marie Auto enr. is an auto repair shop at 7143, rue Saint-André in Montréal. The garage has been in business for over 15 years. Its customers rate it 4.7 out of 5 on Google (98 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-844-8179."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-844-8179.", "A question or an estimate? The fastest way: a call to 514-844-8179."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nJean-Marie Auto enr. recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-844-8179.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Jean-Marie Auto enr., 7143, rue Saint-André, Montréal (Québec) H2R 1V4.", "DRAFT FOR THE GARAGE TO APPROVE\n\nJean-Marie Auto enr. collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-844-8179.\n\nPerson responsible for personal information: [name to be completed], Jean-Marie Auto enr., 7143, rue Saint-André, Montréal (Québec) H2R 1V4."),
