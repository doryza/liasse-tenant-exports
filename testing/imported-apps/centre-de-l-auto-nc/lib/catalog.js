/**
 * PROPOSED service list — Centre de l’Auto NC has not published its services anywhere we
 ...
 * confirms what the garage offers (Services et prix). Mécanique générale is confirmed: the Google listing says « Provides: Mécanique générale ».
