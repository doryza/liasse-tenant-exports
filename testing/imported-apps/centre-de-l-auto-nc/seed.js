 ...
 * Dossier (Google: address, phone, rating 5.0/86, 5+ years, « Provides: Mécanique générale » → confirmed, « Opens 8 a.m. Fri ») vs PagesJaunes (same phone and street) Mon–Thu 07:30–17:00, Fri 07:30–13:30 → CONFLICT on opening time: hours not used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Centre de l’Auto NC",
  contact_phone: '514-354-1440',
  business_address: "10755, rue Pascal-Gagnon, Montréal-Nord (Québec) H1P 1Z9",
  ...
  hero_subtitle: J("Noté 5,0 sur 5 par 86 clients sur Google (septembre 2026), en affaires depuis plus de 5 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 5.0 out of 5 by 86 customers on Google (September 2026), in business for over 5 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Centre de l’Auto NC est un garage de mécanique automobile situé au 10755, rue Pascal-Gagnon, à Montréal-Nord. Le garage est en affaires depuis plus de 5 ans. Ses clients lui donnent 5,0 sur 5 sur Google (86 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-354-1440.", "Centre de l’Auto NC is an auto repair shop at 10755, rue Pascal-Gagnon in Montréal-Nord. The garage has been in business for over 5 years. Its customers rate it 5.0 out of 5 on Google (86 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-354-1440."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-354-1440.", "A question or an estimate? The fastest way: a call to 514-354-1440."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nCentre de l’Auto NC recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-354-1440.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Centre de l’Auto NC, 10755, rue Pascal-Gagnon, Montréal-Nord (Québec) H1P 1Z9.", "DRAFT FOR THE GARAGE TO APPROVE\n\nCentre de l’Auto NC collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-354-1440.\n\nPerson responsible for personal information: [name to be completed], Centre de l’Auto NC, 10755, rue Pascal-Gagnon, Montréal-Nord (Québec) H1P 1Z9."),
