 ...
 * Dossier only (Google: address, phone, 3+ years, no reviews; tire promo in white and gold on black). No PagesJaunes page: draft-to-confirm.
...
const SETTINGS = {
  business_name: "Pneus et Mécanique L.P",
  contact_phone: '438-815-5226',
  business_address: "3325, 1re Rue, Longueuil (Québec) J3Y 8Y6",
  ...
  hero_title: J("Pneus et mécanique à Longueuil.", "Tires and repairs in Longueuil."),
  ...
  about_text: J("Pneus et Mécanique L.P est un garage de mécanique automobile situé au 3325, 1re Rue, à Longueuil. Le garage est en affaires depuis plus de 3 ans.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 438-815-5226.", "Pneus et Mécanique L.P is an auto repair shop at 3325, 1re Rue in Longueuil. The garage has been in business for over 3 years.\n\nTo check the opening hours or have your vehicle looked at, call 438-815-5226."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 438-815-5226.", "A question or an estimate? The fastest way: a call to 438-815-5226."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nPneus et Mécanique L.P recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 438-815-5226.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Pneus et Mécanique L.P, 3325, 1re Rue, Longueuil (Québec) J3Y 8Y6.", "DRAFT FOR THE GARAGE TO APPROVE\n\nPneus et Mécanique L.P collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 438-815-5226.\n\nPerson responsible for personal information: [name to be completed], Pneus et Mécanique L.P, 3325, 1re Rue, Longueuil (Québec) J3Y 8Y6."),
