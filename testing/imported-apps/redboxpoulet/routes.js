module.exports = function(services) {
  ...
  const T = {
    fr: {
      ...
      order: 'Commander', order_now: 'Pour emporter', order_takeout: 'Commander pour emporter', order_takeout_short: 'Commande en ligne', order_view_menu: 'Voir le menu', learn_more: 'En savoir plus', back_home: "Retour à l'accueil",
      ...
      hero_cta: 'Voir le menu', hero_vip: 'Accès VIP',
      ...
      vip_disc_label: "À l'occasion", vip_disc_value: '15 %',
      vip_offers_note: "Exemples d'avantages — les offres varient et sont ponctuelles, jamais un rabais permanent.",
      vip_scarcity: "Jusqu'à épuisement des stocks — les porte-clés ne sont pas toujours disponibles. Premier arrivé, premier servi, faites vite !",
      ...
      vip_p2_t: 'Rabais en pourcentage', vip_p2_d: "De temps à autre, les membres reçoivent une offre en pourcentage — comme 15 % de rabais. Un avantage ponctuel, pas un rabais permanent.",
    ...
    en: {
      ...
      order: 'Order', order_now: 'Takeout', order_takeout: 'Order for pickup', order_takeout_short: 'Online ordering', order_view_menu: 'See the menu', learn_more: 'Learn more', back_home: 'Back to home',
      ...
      hero_cta: 'See the menu', hero_vip: 'VIP Access',
      ...
      vip_disc_label: 'Occasional', vip_disc_value: '15%',
      vip_offers_note: 'Sample perks — offers rotate and are occasional, never a standing discount.',
      vip_scarcity: "While supplies last — keychains aren't always available. First come, first served, hurry!",
      ...
      vip_p2_t: 'Percentage-off drops', vip_p2_d: 'Every so often, members get a percentage-based offer — like 15% off. An occasional perk, not a standing discount.',
