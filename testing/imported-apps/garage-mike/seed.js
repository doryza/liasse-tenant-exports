 ...
 * Dossier (Google: address, phone, rating 4.8/24) + PagesJaunes 105085813 (same phone/street) with no hours or services. Its shield logo is NOT reproduced. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Mike",
  contact_phone: '579-641-1114',
  business_address: "327, boulevard Curé-Labelle, Laval (Québec) H7L 2Z9",
  ...
  hero_title: J("Garage Mike, à Laval.", "Garage Mike, in Laval."),
  hero_subtitle: J("Noté 4,8 sur 5 par 24 clients sur Google (septembre 2026). Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.8 out of 5 by 24 customers on Google (September 2026). Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Mike est un garage de mécanique automobile situé au 327, boulevard Curé-Labelle, à Laval. Ses clients lui donnent 4,8 sur 5 sur Google (24 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 579-641-1114.", "Garage Mike is an auto repair shop at 327, boulevard Curé-Labelle in Laval. Its customers rate it 4.8 out of 5 on Google (24 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 579-641-1114."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 579-641-1114.", "A question or an estimate? The fastest way: a call to 579-641-1114."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Mike recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 579-641-1114.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Mike, 327, boulevard Curé-Labelle, Laval (Québec) H7L 2Z9.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Mike collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 579-641-1114.\n\nPerson responsible for personal information: [name to be completed], Garage Mike, 327, boulevard Curé-Labelle, Laval (Québec) H7L 2Z9."),
