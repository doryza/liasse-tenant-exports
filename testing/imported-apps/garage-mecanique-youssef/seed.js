 ...
 * Dossier only (Google: address, phone; 4 reviews → rating not quoted; « Open 24 hours » snippet not used). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage mécanique Youssef",
  contact_phone: '514-880-6154',
  business_address: "688B, boulevard Curé-Labelle, Laval (Québec) H7V 2T9",
  ...
  hero_title: J("Votre garage, boulevard Curé-Labelle.", "Your garage on boulevard Curé-Labelle."),
  hero_subtitle: J("Garage de mécanique au 688B, boulevard Curé-Labelle, à Laval. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "An auto repair shop at 688B, boulevard Curé-Labelle in Laval. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage mécanique Youssef est un garage de mécanique automobile situé au 688B, boulevard Curé-Labelle, à Laval.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-880-6154.", "Garage mécanique Youssef is an auto repair shop at 688B, boulevard Curé-Labelle in Laval.\n\nTo check the opening hours or have your vehicle looked at, call 514-880-6154."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-880-6154.", "A question or an estimate? The fastest way: a call to 514-880-6154."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage mécanique Youssef recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-880-6154.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage mécanique Youssef, 688B, boulevard Curé-Labelle, Laval (Québec) H7V 2T9.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage mécanique Youssef collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-880-6154.\n\nPerson responsible for personal information: [name to be completed], Garage mécanique Youssef, 688B, boulevard Curé-Labelle, Laval (Québec) H7V 2T9."),
