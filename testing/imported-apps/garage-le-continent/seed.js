 ...
 * Dossier only (Google: address, phone, rating 4.9/63; « Opens 9 a.m. Fri » snippet not a schedule). No PagesJaunes page with this phone. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Le CONTINENT",
  contact_phone: '450-616-4373',
  business_address: "793, boulevard Taschereau, Longueuil (Québec) J4K 2X1",
  ...
  hero_title: J("Mécanique à Longueuil.", "Auto repair in Longueuil."),
  hero_subtitle: J("Noté 4,9 sur 5 par 63 clients sur Google (septembre 2026). Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.9 out of 5 by 63 customers on Google (September 2026). Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Le CONTINENT est un garage de mécanique automobile situé au 793, boulevard Taschereau, à Longueuil. Ses clients lui donnent 4,9 sur 5 sur Google (63 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-616-4373.", "Garage Le CONTINENT is an auto repair shop at 793, boulevard Taschereau in Longueuil. Its customers rate it 4.9 out of 5 on Google (63 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-616-4373."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-616-4373.", "A question or an estimate? The fastest way: a call to 450-616-4373."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Le CONTINENT recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-616-4373.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Le CONTINENT, 793, boulevard Taschereau, Longueuil (Québec) J4K 2X1.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Le CONTINENT collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-616-4373.\n\nPerson responsible for personal information: [name to be completed], Garage Le CONTINENT, 793, boulevard Taschereau, Longueuil (Québec) J4K 2X1."),
