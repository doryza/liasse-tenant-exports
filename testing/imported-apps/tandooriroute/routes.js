module.exports = function(services) {
  ...
  const T = {
    fr: {
      ...
      menu_title: 'Notre menu', menu_subtitle: "Des plats préparés à la commande, du tandoor aux biryanis. Pain naan fait à la main, cuit sur place.",
    ...
    en: {
      ...
      menu_title: 'Our menu', menu_subtitle: 'Made-to-order dishes — from the tandoor to the biryanis. Hand-made naan, baked in-house.',
