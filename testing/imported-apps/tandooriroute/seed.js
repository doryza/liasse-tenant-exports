module.exports = async function(db, services) {
  ...
  if (!menuCount || Number(menuCount.c) === 0) {
    const items = [
      ...
      ['Poulet Tikka Tandoori', 'Tandoori Chicken Tikka', "Cubes de poulet marinés dans notre mélange d'épices secret puis cuits au tandoor à 480°C. Croûte fumée, cœur tendre et juteux.", "Chicken cubes marinated in our secret spice blend and roasted in the tandoor at 480°C. Smoky crust, tender juicy center.", 17.49, 'tandoor', '', 2, 1, 1],
      ['Agneau Rogan Josh', 'Lamb Rogan Josh', "Agneau mijoté lentement dans une sauce aromatique au cachemire — yogourt, oignons caramélisés, gingembre frais et notre garam masala maison.", "Lamb slow-simmered in a fragrant Kashmiri sauce — yogurt, caramelized onions, fresh ginger and our house garam masala.", 21.99, 'curry', '', 3, 1, 1],
      ['Butter Chicken', 'Butter Chicken', "Le classique incontournable : poulet tandoori dans une sauce crémeuse à la tomate, beurre indien et fenugrec. Onctueux et légèrement sucré.", "The classic favorite: tandoori chicken in a creamy tomato sauce with Indian butter and fenugreek. Silky and subtly sweet.", 18.49, 'curry', '', 4, 1, 1],
      ['Paneer Tikka Masala', 'Paneer Tikka Masala', "Cubes de fromage paneer maison grillés au tandoor, mijotés dans une sauce tomate-cardamome onctueuse. 100% végétarien.", "House paneer cubes grilled in the tandoor, simmered in a velvety tomato-cardamom sauce. 100% vegetarian.", 16.99, 'vege', '', 5, 1, 1],
      ['Chana Masala', 'Chana Masala', "Pois chiches mijotés aux épices du Pendjab, tomates fraîches, gingembre et coriandre. Réconfortant et vegan.", "Chickpeas simmered in Punjabi spices, fresh tomatoes, ginger and cilantro. Comforting and vegan.", 13.99, 'vege', '', 6, 0, 1],
      ['Naan à l\'ail & beurre', 'Garlic Butter Naan', "Pain naan cuit au tandoor, badigeonné de beurre, ail frais et coriandre. Sort encore fumant.", "Naan bread baked in the tandoor, brushed with butter, fresh garlic and cilantro. Served piping hot.", 4.49, 'pain', '', 7, 0, 1],
      ['Samosa aux légumes (2 mcx)', 'Vegetable Samosas (2 pcs)', "Chaussons croustillants faits maison, garnis de pommes de terre épicées et petits pois. Servis avec chutney tamarin.", "Crispy house-made pastries filled with spiced potatoes and peas. Served with tamarind chutney.", 6.99, 'pain', '', 8, 0, 1],
      ['Gulab Jamun (3 mcx)', 'Gulab Jamun (3 pcs)', "Beignets de lait moelleux trempés dans un sirop à la cardamome et à l'eau de rose. Le dessert préféré de l'Inde.", "Soft milk dumplings soaked in cardamom and rose-water syrup. India's beloved dessert.", 6.99, 'dessert', '', 9, 0, 1],
      ['Mango Lassi', 'Mango Lassi', "Boisson rafraîchissante au yogourt, mangue Alphonso et une touche de cardamome. L'accompagnement parfait des plats épicés.", "Refreshing yogurt drink with Alphonso mango and a touch of cardamom. The perfect companion to spicy dishes.", 4.99, 'dessert', '', 10, 0, 1]
    ];
