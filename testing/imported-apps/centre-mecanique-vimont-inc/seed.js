 ...
 * Dossier (Google: Centre Mécanique Vimont Inc, address, phone, rating 4.7/101, 15+ years) + PagesJaunes 6568944 (same phone/address) with no hours or services. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Centre Mécanique Vimont",
  contact_phone: '450-625-1588',
  business_address: "4953, boulevard des Laurentides, Laval (Québec) H7K 2J6",
  ...
  hero_title: J("Le centre mécanique de Vimont.", "Vimont’s repair centre."),
  hero_subtitle: J("Noté 4,7 sur 5 par 101 clients sur Google (septembre 2026), en affaires depuis plus de 15 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.7 out of 5 by 101 customers on Google (September 2026), in business for over 15 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Centre Mécanique Vimont est un garage de mécanique automobile situé au 4953, boulevard des Laurentides, à Laval. Le garage est en affaires depuis plus de 15 ans. Ses clients lui donnent 4,7 sur 5 sur Google (101 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-625-1588.", "Centre Mécanique Vimont is an auto repair shop at 4953, boulevard des Laurentides in Laval. The garage has been in business for over 15 years. Its customers rate it 4.7 out of 5 on Google (101 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-625-1588."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-625-1588.", "A question or an estimate? The fastest way: a call to 450-625-1588."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nCentre Mécanique Vimont recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-625-1588.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Centre Mécanique Vimont, 4953, boulevard des Laurentides, Laval (Québec) H7K 2J6.", "DRAFT FOR THE GARAGE TO APPROVE\n\nCentre Mécanique Vimont collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-625-1588.\n\nPerson responsible for personal information: [name to be completed], Centre Mécanique Vimont, 4953, boulevard des Laurentides, Laval (Québec) H7K 2J6."),
