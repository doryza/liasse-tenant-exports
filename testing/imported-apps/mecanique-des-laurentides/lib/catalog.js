/**
 * PROPOSED service list — Mécanique des Laurentides has not published its
 * services anywhere we could verify (dossier: « Auto repair shop », PagesJaunes
 * lists no services). These are the usual services of a general repair shop,
 * every one flagged confirmed: 0 so the site shows « À confirmer » until the
 * owner confirms what the garage actually offers (Services et prix).
