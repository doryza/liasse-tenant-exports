 ...
 * Dossier only (Google: Garage de Mécanique Automobile Roy Inc., address, phone, rating 4.8/506, 7+ years). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage de Mécanique Automobile Roy",
  contact_phone: '514-748-7281',
  business_address: "955, rue Roy, Saint-Laurent (Québec) H4L 3T8",
  ...
  hero_title: J("Votre garage à\u00a0Saint-⁠Laurent.", "Your garage in\u00a0Saint-⁠Laurent."),
  hero_subtitle: J("Noté 4,8 sur 5 par 506 clients sur Google (septembre 2026), en affaires depuis plus de 7 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.8 out of 5 by 506 customers on Google (September 2026), in business for over 7 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage de Mécanique Automobile Roy est un garage de mécanique automobile situé au 955, rue Roy, à Saint-Laurent. Le garage est en affaires depuis plus de 7 ans. Ses clients lui donnent 4,8 sur 5 sur Google (506 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-748-7281.", "Garage de Mécanique Automobile Roy is an auto repair shop at 955, rue Roy in Saint-Laurent. The garage has been in business for over 7 years. Its customers rate it 4.8 out of 5 on Google (506 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-748-7281."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-748-7281.", "A question or an estimate? The fastest way: a call to 514-748-7281."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage de Mécanique Automobile Roy recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-748-7281.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage de Mécanique Automobile Roy, 955, rue Roy, Saint-Laurent (Québec) H4L 3T8.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage de Mécanique Automobile Roy collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-748-7281.\n\nPerson responsible for personal information: [name to be completed], Garage de Mécanique Automobile Roy, 955, rue Roy, Saint-Laurent (Québec) H4L 3T8."),
