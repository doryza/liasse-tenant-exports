 ...
 * Dossier (Google: GARAGE AUTO CONFIANCE, address, phone, rating 4.9/46, 15+ years, « Opens 8 a.m. Fri »; black/orange promo NOT reproduced) vs PagesJaunes 7772788 « Auto Confiance » (same phone and street) hours Mon–Fri 08:30–17:00 → CONFLICT on opening time: hours not used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Auto Confiance",
  contact_phone: '450-435-7639',
  business_address: "13413, boulevard du Curé-Labelle, Mirabel (Québec) J7J 1H1",
  ...
  hero_title: J("Votre garage à Mirabel.", "Your garage in Mirabel."),
  hero_subtitle: J("Noté 4,9 sur 5 par 46 clients sur Google (septembre 2026), en affaires depuis plus de 15 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.9 out of 5 by 46 customers on Google (September 2026), in business for over 15 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Auto Confiance est un garage de mécanique automobile situé au 13413, boulevard du Curé-Labelle, à Mirabel. Le garage est en affaires depuis plus de 15 ans. Ses clients lui donnent 4,9 sur 5 sur Google (46 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-435-7639.", "Garage Auto Confiance is an auto repair shop at 13413, boulevard du Curé-Labelle in Mirabel. The garage has been in business for over 15 years. Its customers rate it 4.9 out of 5 on Google (46 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-435-7639."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-435-7639.", "A question or an estimate? The fastest way: a call to 450-435-7639."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Auto Confiance recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-435-7639.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Auto Confiance, 13413, boulevard du Curé-Labelle, Mirabel (Québec) J7J 1H1.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Auto Confiance collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-435-7639.\n\nPerson responsible for personal information: [name to be completed], Garage Auto Confiance, 13413, boulevard du Curé-Labelle, Mirabel (Québec) J7J 1H1."),
