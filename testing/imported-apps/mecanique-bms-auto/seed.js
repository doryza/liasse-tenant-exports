 ...
 * Dossier only (Google: MECANIQUE BMS AUTO, address, phone, rating 4.8/377, 5+ years). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Mécanique BMS Auto",
  contact_phone: '514-797-9646',
  business_address: "10760, avenue Salk, Montréal-Nord (Québec) H1G 4Y1",
  ...
  hero_title: J("BMS Auto, à Montréal-⁠Nord.", "BMS Auto, in Montréal-⁠Nord."),
  hero_subtitle: J("Noté 4,8 sur 5 par 377 clients sur Google (septembre 2026), en affaires depuis plus de 5 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.8 out of 5 by 377 customers on Google (September 2026), in business for over 5 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Mécanique BMS Auto est un garage de mécanique automobile situé au 10760, avenue Salk, à Montréal-Nord. Le garage est en affaires depuis plus de 5 ans. Ses clients lui donnent 4,8 sur 5 sur Google (377 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-797-9646.", "Mécanique BMS Auto is an auto repair shop at 10760, avenue Salk in Montréal-Nord. The garage has been in business for over 5 years. Its customers rate it 4.8 out of 5 on Google (377 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-797-9646."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-797-9646.", "A question or an estimate? The fastest way: a call to 514-797-9646."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nMécanique BMS Auto recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-797-9646.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Mécanique BMS Auto, 10760, avenue Salk, Montréal-Nord (Québec) H1G 4Y1.", "DRAFT FOR THE GARAGE TO APPROVE\n\nMécanique BMS Auto collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-797-9646.\n\nPerson responsible for personal information: [name to be completed], Mécanique BMS Auto, 10760, avenue Salk, Montréal-Nord (Québec) H1G 4Y1."),
