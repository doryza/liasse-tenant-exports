module.exports = async function(db) {
  ...
  const settings = [
    ['_p_hero_image_url', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444523/tapavis_tenant_pavage/build_pavage_1777444523436.png'],
  ...
  if (Number(projectCount.c) === 0) {
    const projects = [
      ['Entrée à motif chevron - Westmount', 'Magnifique entrée résidentielle de 250 m² avec pavés autobloquants en motif chevron. Bordures décoratives et drainage optimisé.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444519/tapavis_tenant_pavage/build_pavage_1777444519116.png', 'driveway', 'Westmount, QC', '2024-09-15', 1],
      ['Patio arrière de luxe - Laval', 'Aménagement complet d’un patio de 80 m² avec pavés de pierre naturelle, foyer extérieur intégré et éclairage paysager.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444520/tapavis_tenant_pavage/build_pavage_1777444520095.png', 'patio', 'Laval, QC', '2024-08-20', 1],
      ['Asphaltage résidentiel - Brossard', 'Asphaltage complet d’une entrée double de 180 m² avec finition lisse, scellant haute qualité et bordures béton.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444531/tapavis_tenant_pavage/build_pavage_1777444531451.png', 'asphalt', 'Brossard, QC', '2024-07-10', 1],
      ['Allée de jardin - Outremont', 'Création d’une allée sinueuse en pavés de pierre naturelle reliant la rue à l’entrée principale. 45 m linéaires.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444537/tapavis_tenant_pavage/build_pavage_1777444537880.png', 'walkway', 'Outremont, QC', '2024-06-25', 1],
      ['Terrasse de piscine - Saint-Lambert', 'Aménagement d’une terrasse de piscine moderne en pavés grand format. Surface antidérapante et résistante au chlore.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444529/tapavis_tenant_pavage/build_pavage_1777444529129.png', 'patio', 'Saint-Lambert, QC', '2024-05-30', 1],
      ['Entrée circulaire - Mont-Royal', 'Entrée circulaire prestigieuse de 320 m² avec bordure décorative et fontaine centrale. Pavés haut de gamme.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444518/tapavis_tenant_pavage/build_pavage_1777444518893.png', 'driveway', 'Mont-Royal, QC', '2024-09-05', 1]
    ];
  ...
  if (Number(serviceCount.c) === 0) {
    const svc = [
      ['Pavés autobloquants', 'Installation professionnelle de pavés autobloquants pour entrées, patios et allées. Large choix de couleurs et motifs.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444518/tapavis_tenant_pavage/build_pavage_1777444518413.png', 'grid', '85$ - 150$ / m²', 1, 1],
      ['Asphaltage', 'Asphaltage neuf et resurfaçage de qualité supérieure pour entrées résidentielles. Finition impeccable.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444519/tapavis_tenant_pavage/build_pavage_1777444519909.png', 'truck', '12$ - 20$ / m²', 1, 2],
      ['Pierre naturelle', 'Aménagement haut de gamme avec pierres naturelles québécoises. Esthétique unique et durable.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444537/tapavis_tenant_pavage/build_pavage_1777444537880.png', 'mountain', '120$ - 250$ / m²', 1, 3],
      ['Réparation et scellement', 'Réparation de fissures, nivellement et application de scellant pour prolonger la durée de vie de votre pavage.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444531/tapavis_tenant_pavage/build_pavage_1777444531451.png', 'wrench', 'Sur devis', 0, 4],
      ['Bordures et finitions', 'Installation de bordures béton, drainage et finitions décoratives pour parfaire votre projet.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444520/tapavis_tenant_pavage/build_pavage_1777444520095.png', 'ruler', 'Sur devis', 0, 5],
      ['Aménagement complet', 'Service clé en main : conception, excavation, drainage, pavage et aménagement paysager.', 'https://res.cloudinary.com/duhp69meg/image/upload/v1777444529/tapavis_tenant_pavage/build_pavage_1777444529129.png', 'home', 'Sur devis', 1, 6]
    ];
    for (const s of svc) {
