 ...
 * Dossier only (Google: address, phone, rating 4.8/44, 3+ years). No PagesJaunes page with this phone. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Mécanique M.D.S.",
  contact_phone: '514-992-1908',
  business_address: "1627, rue Principale, Laval (Québec) H7X 4B1",
  ...
  hero_title: J("Votre garage, rue Principale.", "Your garage on rue Principale."),
  hero_subtitle: J("Noté 4,8 sur 5 par 44 clients sur Google (septembre 2026), en affaires depuis plus de 3 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.8 out of 5 by 44 customers on Google (September 2026), in business for over 3 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Mécanique M.D.S. est un garage de mécanique automobile situé au 1627, rue Principale, à Laval. Le garage est en affaires depuis plus de 3 ans. Ses clients lui donnent 4,8 sur 5 sur Google (44 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-992-1908.", "Garage Mécanique M.D.S. is an auto repair shop at 1627, rue Principale in Laval. The garage has been in business for over 3 years. Its customers rate it 4.8 out of 5 on Google (44 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-992-1908."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-992-1908.", "A question or an estimate? The fastest way: a call to 514-992-1908."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Mécanique M.D.S. recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-992-1908.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Mécanique M.D.S., 1627, rue Principale, Laval (Québec) H7X 4B1.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Mécanique M.D.S. collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-992-1908.\n\nPerson responsible for personal information: [name to be completed], Garage Mécanique M.D.S., 1627, rue Principale, Laval (Québec) H7X 4B1."),
