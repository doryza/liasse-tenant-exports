/**
 * Service catalogue — the twelve services Mécanique Jean-Maurice lists on its
 * public 411garage.com profile, in the order it lists them. Descriptions are
 * general automotive guidance (what the service is, the signs that call for
 * it), never claims about this garage's prices, warranties, brands or
 * history. Durations are planning estimates the owner edits in the back
 * office; prices are absent on purpose (« Sur estimation ») until the owner
 * enters them. Seeded once by seed.js.
 */
module.exports = [
  {
  ...
  },
  {
    ...
    "tagline": "Coréennes, japonaises et allemandes.",
    "tagline_en": "Korean, Japanese and German cars.",
    "body": "Le garage entretient et répare les voitures importées : coréennes, japonaises et allemandes. Au rendez-vous, indiquez la marque, le modèle et l’année (ou le NIV) : les pièces et les intervalles d’entretien varient d’un constructeur à l’autre.",
    "body_en": "The garage services and repairs imported cars: Korean, Japanese and German. When you book, give the make, model and year (or the VIN): parts and service intervals vary from one manufacturer to another.",
