 ...
 * Dossier only (Google: « Garage - Centre Auto Mobile », address, phone, rating 5.0/18, 5+ years; white-on-black wordmark with a wrench NOT reproduced). No PagesJaunes page with this phone. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Centre Auto Mobile",
  contact_phone: '514-346-7133',
  business_address: "22, boulevard Industriel, Saint-Eustache (Québec) J7R 5C1",
  ...
  hero_title: J("Votre garage à Saint-⁠Eustache.", "Your garage in Saint-⁠Eustache."),
  hero_subtitle: J("Noté 5,0 sur 5 par 18 clients sur Google (septembre 2026), en affaires depuis plus de 5 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 5.0 out of 5 by 18 customers on Google (September 2026), in business for over 5 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Centre Auto Mobile est un garage de mécanique automobile situé au 22, boulevard Industriel, à Saint-Eustache. Le garage est en affaires depuis plus de 5 ans. Ses clients lui donnent 5,0 sur 5 sur Google (18 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-346-7133.", "Garage Centre Auto Mobile is an auto repair shop at 22, boulevard Industriel in Saint-Eustache. The garage has been in business for over 5 years. Its customers rate it 5.0 out of 5 on Google (18 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-346-7133."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-346-7133.", "A question or an estimate? The fastest way: a call to 514-346-7133."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Centre Auto Mobile recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-346-7133.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Centre Auto Mobile, 22, boulevard Industriel, Saint-Eustache (Québec) J7R 5C1.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Centre Auto Mobile collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-346-7133.\n\nPerson responsible for personal information: [name to be completed], Garage Centre Auto Mobile, 22, boulevard Industriel, Saint-Eustache (Québec) J7R 5C1."),
