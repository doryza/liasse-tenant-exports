 ...
 * Dossier only (Google: Réparation Univers Automobile Inc., address, phone, rating 4.9/79, 10+ years, « Provides: diagnostic des problèmes mécaniques et électroniques » → Mécanique générale confirmed). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Réparation Univers Automobile",
  contact_phone: '438-233-0449',
  business_address: "524, rue du Curé-Comtois, Terrebonne (Québec) J6W 3Y8",
  ...
  hero_title: J("Réparation automobile à Terrebonne.", "Car repair in Terrebonne."),
  hero_subtitle: J("Noté 4,9 sur 5 par 79 clients sur Google (septembre 2026), en affaires depuis plus de 10 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.9 out of 5 by 79 customers on Google (September 2026), in business for over 10 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Réparation Univers Automobile est un garage de mécanique automobile situé au 524, rue du Curé-Comtois, à Terrebonne. Le garage est en affaires depuis plus de 10 ans. Ses clients lui donnent 4,9 sur 5 sur Google (79 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 438-233-0449.", "Réparation Univers Automobile is an auto repair shop at 524, rue du Curé-Comtois in Terrebonne. The garage has been in business for over 10 years. Its customers rate it 4.9 out of 5 on Google (79 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 438-233-0449."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 438-233-0449.", "A question or an estimate? The fastest way: a call to 438-233-0449."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nRéparation Univers Automobile recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 438-233-0449.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Réparation Univers Automobile, 524, rue du Curé-Comtois, Terrebonne (Québec) J6W 3Y8.", "DRAFT FOR THE GARAGE TO APPROVE\n\nRéparation Univers Automobile collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 438-233-0449.\n\nPerson responsible for personal information: [name to be completed], Réparation Univers Automobile, 524, rue du Curé-Comtois, Terrebonne (Québec) J6W 3Y8."),
