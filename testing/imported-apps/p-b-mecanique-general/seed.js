 ...
 * Dossier (Google: address, phone, rating 4.9/18, 7+ years, « Opens 8 a.m. Fri ») + PagesJaunes 101310391 « P&B Extrême Tuning Auto Mécano » (same phone/address) with hours from 07:00 → CONFLICT with Google, hours not used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "P&B Mécanique Général",
  contact_phone: '450-657-3880',
  business_address: "555, chemin de la Presqu’île, Repentigny (Québec) J5Z 4C7",
  ...
  hero_title: J("P&B, chemin de la Presqu’île.", "P&B on chemin de la Presqu’île."),
  hero_subtitle: J("Noté 4,9 sur 5 par 18 clients sur Google (septembre 2026), en affaires depuis plus de 7 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.9 out of 5 by 18 customers on Google (September 2026), in business for over 7 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("P&B Mécanique Général est un garage de mécanique automobile situé au 555, chemin de la Presqu’île, à Repentigny. Le garage est en affaires depuis plus de 7 ans. Ses clients lui donnent 4,9 sur 5 sur Google (18 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-657-3880.", "P&B Mécanique Général is an auto repair shop at 555, chemin de la Presqu’île in Repentigny. The garage has been in business for over 7 years. Its customers rate it 4.9 out of 5 on Google (18 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-657-3880."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-657-3880.", "A question or an estimate? The fastest way: a call to 450-657-3880."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nP&B Mécanique Général recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-657-3880.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], P&B Mécanique Général, 555, chemin de la Presqu’île, Repentigny (Québec) J5Z 4C7.", "DRAFT FOR THE GARAGE TO APPROVE\n\nP&B Mécanique Général collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-657-3880.\n\nPerson responsible for personal information: [name to be completed], P&B Mécanique Général, 555, chemin de la Presqu’île, Repentigny (Québec) J5Z 4C7."),
