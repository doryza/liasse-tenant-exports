 ...
 * Dossier only (Google: address, phone, rating 5.0/18, « Provides: Auto engine diagnostic » → Mécanique générale confirmed). No PagesJaunes page: draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Mike S",
  contact_phone: '514-773-2846',
  business_address: "895, boulevard Arthur-Sauvé, local D, Saint-Eustache (Québec) J7R 4K3",
  ...
  hero_title: J("Votre garage à Saint-⁠Eustache.", "Your Saint-⁠Eustache garage."),
  hero_subtitle: J("Noté 5,0 sur 5 par 18 clients sur Google (septembre 2026). Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 5.0 out of 5 by 18 customers on Google (September 2026). Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Mike S est un garage de mécanique automobile situé au 895, boulevard Arthur-Sauvé, local D, à Saint-Eustache. Ses clients lui donnent 5,0 sur 5 sur Google (18 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 514-773-2846.", "Garage Mike S is an auto repair shop at 895, boulevard Arthur-Sauvé, local D in Saint-Eustache. Its customers rate it 5.0 out of 5 on Google (18 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 514-773-2846."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 514-773-2846.", "A question or an estimate? The fastest way: a call to 514-773-2846."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Mike S recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 514-773-2846.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Mike S, 895, boulevard Arthur-Sauvé, local D, Saint-Eustache (Québec) J7R 4K3.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Mike S collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 514-773-2846.\n\nPerson responsible for personal information: [name to be completed], Garage Mike S, 895, boulevard Arthur-Sauvé, local D, Saint-Eustache (Québec) J7R 4K3."),
