 ...
 * Dossier only (Google: address, phone, rating 5.0/15, 5+ years; « Closes 9 p.m. » snippet not a schedule). No PagesJaunes page with this phone. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "MK Pro Mécanique",
  contact_phone: '438-404-3145',
  business_address: "3950, boulevard Henri-Bourassa Est, Montréal-Nord (Québec) H1H 1K9",
  ...
  hero_title: J("Mécanique à Montréal-⁠Nord.", "Auto repair in Montréal-⁠Nord."),
  hero_subtitle: J("Noté 5,0 sur 5 par 15 clients sur Google (septembre 2026), en affaires depuis plus de 5 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 5.0 out of 5 by 15 customers on Google (September 2026), in business for over 5 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("MK Pro Mécanique est un garage de mécanique automobile situé au 3950, boulevard Henri-Bourassa Est, à Montréal-Nord. Le garage est en affaires depuis plus de 5 ans. Ses clients lui donnent 5,0 sur 5 sur Google (15 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 438-404-3145.", "MK Pro Mécanique is an auto repair shop at 3950, boulevard Henri-Bourassa Est in Montréal-Nord. The garage has been in business for over 5 years. Its customers rate it 5.0 out of 5 on Google (15 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 438-404-3145."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 438-404-3145.", "A question or an estimate? The fastest way: a call to 438-404-3145."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nMK Pro Mécanique recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 438-404-3145.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], MK Pro Mécanique, 3950, boulevard Henri-Bourassa Est, Montréal-Nord (Québec) H1H 1K9.", "DRAFT FOR THE GARAGE TO APPROVE\n\nMK Pro Mécanique collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 438-404-3145.\n\nPerson responsible for personal information: [name to be completed], MK Pro Mécanique, 3950, boulevard Henri-Bourassa Est, Montréal-Nord (Québec) H1H 1K9."),
