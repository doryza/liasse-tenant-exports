...
module.exports = function(services){
  ...
  var T = {
    fr: {
      ...
      esp_main_headline_help:"Le grand titre en haut de votre page. Vide = le texte grisé ci-dessus reste affiché.",
      esp_subtitle_label:"Sous-titre",
      esp_subtitle_help:"Le paragraphe sous le titre — votre promesse au vendeur. Vide = texte par défaut.",
      esp_note_under_field_label:"Note sous le champ",
      esp_note_under_field_help:"La ligne rassurante sous le champ d'adresse (frais, délai de réponse…). Vide = texte par défaut.",
      ...
      esp_campaign_name_street_tagline:"Désignez une rue. Nous frappons les portes les plus proches.",
    ...
    en: {
      ...
      esp_bio_help:"The paragraph in the «&nbsp;The agent&nbsp;» section of your page — your philosophy, your approach, in one or two sentences. Empty = the greyed text above stays in place.",
      esp_section_your_hook:"Your hook",
      esp_main_headline_label:"Main headline",
      esp_main_headline_help:"The big headline at the top of your page. Empty = the greyed text above stays in place.",
      esp_subtitle_label:"Subtitle",
      esp_subtitle_help:"The paragraph under the headline — your promise to the seller. Empty = default text.",
      esp_note_under_field_label:"Note under the field",
      esp_note_under_field_help:"The reassuring line under the address field (fees, reply time…). Empty = default text.",
      ...
      esp_campaign_name_street_tagline:"Name a street. We knock on the closest doors.",
