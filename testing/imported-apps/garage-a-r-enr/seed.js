 ...
 * Dossier (Google: Garage A&R Enr, address, phone, rating 4.7/57, 10+ years) + PagesJaunes « A & R Pagé Inc » (same phone, same street): « Mécanique volkswagen » → confirmed; « Travail garanti » NOT used (warranty claim); hours 20:00–17:00 invalid → NOT used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage A&R",
  contact_phone: '450-432-8185',
  business_address: "901, rue Labelle, Saint-Jérôme (Québec) J7Z 5M6",
  ...
  hero_subtitle: J("Noté 4,7 sur 5 par 57 clients sur Google (septembre 2026), en affaires depuis plus de 10 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.7 out of 5 by 57 customers on Google (September 2026), in business for over 10 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage A&R est un garage de mécanique automobile situé au 901, rue Labelle, à Saint-Jérôme. Le garage est en affaires depuis plus de 10 ans. Ses clients lui donnent 4,7 sur 5 sur Google (57 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-432-8185.", "Garage A&R is an auto repair shop at 901, rue Labelle in Saint-Jérôme. The garage has been in business for over 10 years. Its customers rate it 4.7 out of 5 on Google (57 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-432-8185."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-432-8185.", "A question or an estimate? The fastest way: a call to 450-432-8185."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage A&R recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-432-8185.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage A&R, 901, rue Labelle, Saint-Jérôme (Québec) J7Z 5M6.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage A&R collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-432-8185.\n\nPerson responsible for personal information: [name to be completed], Garage A&R, 901, rue Labelle, Saint-Jérôme (Québec) J7Z 5M6."),
