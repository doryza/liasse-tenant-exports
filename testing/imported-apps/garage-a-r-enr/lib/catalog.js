/**
 * PROPOSED service list — Garage A&R has not published its services anywhere we
 ...
 * confirms what the garage offers (Services et prix). Mécanique Volkswagen is confirmed: the garage’s PagesJaunes listing names it.
...
module.exports = [
  ...
  {
    "slug": "mecanique-volkswagen",
    "icon": "car",
    "duration_min": 60,
    "bookable": 1,
    "featured": 1,
    "name": "Mécanique Volkswagen",
    "name_en": "Volkswagen repair",
    "tagline": "Indiquée par le garage parmi ses services.",
    "tagline_en": "Listed by the garage among its services.",
    "body": "La fiche du garage indique la mécanique Volkswagen parmi ses services. Pour un entretien ou une réparation, précisez le modèle, l’année et le moteur (essence ou diesel) en réservant : les pièces et les intervalles varient selon la génération.",
    "body_en": "The garage’s listing names Volkswagen repair among its services. For maintenance or a repair, give the model, year and engine (gas or diesel) when you book: parts and intervals vary by generation.",
    "signs": "[\"Entretien prévu au carnet\", \"Voyant moteur allumé\", \"Bruit ou comportement nouveau\"]",
    "signs_en": "[\"Scheduled maintenance due\", \"Check-engine light on\", \"A new noise or behaviour\"]",
    "confirmed": 1
  }
];
