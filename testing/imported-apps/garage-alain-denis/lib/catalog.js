/**
 * PROPOSED service list — Garage Alain Denis has not published its services
 * anywhere we could verify (dossier: observed category « Auto repair shop »
 * only). These are the usual services of a general repair shop, every one
 * flagged confirmed: 0 so the site shows « À confirmer » until the owner
 * confirms what the garage actually offers (Services et prix). Descriptions
 * are general automotive guidance, never claims about this garage.
 */
module.exports = [
  {
