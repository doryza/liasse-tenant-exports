 ...
 * Dossier only (Google: Mécanique Piette 2000 inc., address, phone; 4 reviews → rating not quoted; Facebook only). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Mécanique Piette 2000",
  contact_phone: '450-541-0780',
  business_address: "117, chemin des Commissaires, local F, L’Assomption (Québec) J5W 2T6",
  payment_methods: J("À confirmer — demandez au garage.", "To be confirmed — ask the garage."),
  service_areas: J("L’Assomption et les environs", "L’Assomption and nearby"),
  hero_title: J("Votre garage à L’Assomption.", "Your garage in L’Assomption."),
  hero_subtitle: J("Garage de mécanique au 117, chemin des Commissaires, local F, à L’Assomption. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "An auto repair shop at 117, chemin des Commissaires, local F in L’Assomption. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Mécanique Piette 2000 est un garage de mécanique automobile situé au 117, chemin des Commissaires, local F, à L’Assomption.\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-541-0780.", "Mécanique Piette 2000 is an auto repair shop at 117, chemin des Commissaires, local F in L’Assomption.\n\nTo check the opening hours or have your vehicle looked at, call 450-541-0780."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-541-0780.", "A question or an estimate? The fastest way: a call to 450-541-0780."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nMécanique Piette 2000 recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-541-0780.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Mécanique Piette 2000, 117, chemin des Commissaires, local F, L’Assomption (Québec) J5W 2T6.", "DRAFT FOR THE GARAGE TO APPROVE\n\nMécanique Piette 2000 collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-541-0780.\n\nPerson responsible for personal information: [name to be completed], Mécanique Piette 2000, 117, chemin des Commissaires, local F, L’Assomption (Québec) J5W 2T6."),
