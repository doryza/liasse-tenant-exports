 ...
 * Dossier only (Google: address, phone, rating 4.9/27, 7+ years, « Car repair and maintenance service»). No matching PagesJaunes page: draft-to-confirm.
...
const SETTINGS = {
  business_name: "Les Pros de l’auto DJ",
  contact_phone: '450-430-3751',
  business_address: "14575, boulevard du Curé-Labelle, Mirabel (Québec) J7J 1M2",
  ...
  hero_title: J("Les pros de l’auto, à Mirabel.", "Auto pros in Mirabel."),
  hero_subtitle: J("Noté 4,9 sur 5 par 27 clients sur Google (septembre 2026), en affaires depuis plus de 7 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.9 out of 5 by 27 customers on Google (September 2026), in business for over 7 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Les Pros de l’auto DJ est un garage de mécanique automobile situé au 14575, boulevard du Curé-Labelle, à Mirabel. Le garage est en affaires depuis plus de 7 ans. Ses clients lui donnent 4,9 sur 5 sur Google (27 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-430-3751.", "Les Pros de l’auto DJ is an auto repair shop at 14575, boulevard du Curé-Labelle in Mirabel. The garage has been in business for over 7 years. Its customers rate it 4.9 out of 5 on Google (27 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-430-3751."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-430-3751.", "A question or an estimate? The fastest way: a call to 450-430-3751."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nLes Pros de l’auto DJ recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-430-3751.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Les Pros de l’auto DJ, 14575, boulevard du Curé-Labelle, Mirabel (Québec) J7J 1M2.", "DRAFT FOR THE GARAGE TO APPROVE\n\nLes Pros de l’auto DJ collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-430-3751.\n\nPerson responsible for personal information: [name to be completed], Les Pros de l’auto DJ, 14575, boulevard du Curé-Labelle, Mirabel (Québec) J7J 1M2."),
