(function () {
  ...
  var RULES = [
    { key: 'oil', every: 8000, fr: 'Vidange d’huile et filtre', en: 'Oil and filter change', slug: 'camionnettes', fromOil: true },
    { key: 'rotation', every: 10000, fr: 'Rotation des pneus', en: 'Tire rotation', slug: 'camionnettes' },
    { key: 'brakes', every: 20000, fr: 'Inspection des freins', en: 'Brake inspection', slug: 'camionnettes' },
    { key: 'air', every: 24000, fr: 'Filtre à air du moteur', en: 'Engine air filter', slug: 'camionnettes' },
    { key: 'cabin', every: 24000, fr: 'Filtre d’habitacle', en: 'Cabin air filter', slug: 'camionnettes' },
    { key: 'trans', every: 80000, fr: 'Huile de transmission', en: 'Transmission fluid', slug: 'camionnettes' },
    { key: 'coolant', every: 160000, fr: 'Liquide de refroidissement', en: 'Engine coolant', slug: 'camionnettes' },
    { key: 'plugs', every: 160000, fr: 'Bougies d’allumage', en: 'Spark plugs', slug: 'camionnettes' },
  ];
