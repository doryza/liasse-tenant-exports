 ...
 * Dossier (Google: address, phone, rating 4.9/64, 15+ years; website mecanique-langlois.jany.io is behind a bot challenge, unread) + PagesJaunes 2666265 (same phone/address) with no hours or services. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Mécanique Langlois",
  contact_phone: '450-963-3669',
  business_address: "560, place Forand, Laval (Québec) H7P 5L9",
  ...
  hero_title: J("Mécanique Langlois, à Laval.", "Mécanique Langlois, in Laval."),
  hero_subtitle: J("Noté 4,9 sur 5 par 64 clients sur Google (septembre 2026), en affaires depuis plus de 15 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.9 out of 5 by 64 customers on Google (September 2026), in business for over 15 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Mécanique Langlois est un garage de mécanique automobile situé au 560, place Forand, à Laval. Le garage est en affaires depuis plus de 15 ans. Ses clients lui donnent 4,9 sur 5 sur Google (64 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 450-963-3669.", "Mécanique Langlois is an auto repair shop at 560, place Forand in Laval. The garage has been in business for over 15 years. Its customers rate it 4.9 out of 5 on Google (64 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 450-963-3669."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 450-963-3669.", "A question or an estimate? The fastest way: a call to 450-963-3669."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nMécanique Langlois recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 450-963-3669.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Mécanique Langlois, 560, place Forand, Laval (Québec) H7P 5L9.", "DRAFT FOR THE GARAGE TO APPROVE\n\nMécanique Langlois collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 450-963-3669.\n\nPerson responsible for personal information: [name to be completed], Mécanique Langlois, 560, place Forand, Laval (Québec) H7P 5L9."),
