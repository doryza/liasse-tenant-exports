 ...
 * Dossier only (Google: address, phone, rating 4.8/209, 3+ years; Instagram only). No PagesJaunes page. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Supérieur",
  contact_phone: '438-454-4545',
  business_address: "1855, boulevard Industriel, Laval (Québec) H7S 1P5",
  ...
  hero_title: J("Garage Supérieur, à Laval.", "Garage Supérieur, in Laval."),
  hero_subtitle: J("Noté 4,8 sur 5 par 209 clients sur Google (septembre 2026), en affaires depuis plus de 3 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.8 out of 5 by 209 customers on Google (September 2026), in business for over 3 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Supérieur est un garage de mécanique automobile situé au 1855, boulevard Industriel, à Laval. Le garage est en affaires depuis plus de 3 ans. Ses clients lui donnent 4,8 sur 5 sur Google (209 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 438-454-4545.", "Garage Supérieur is an auto repair shop at 1855, boulevard Industriel in Laval. The garage has been in business for over 3 years. Its customers rate it 4.8 out of 5 on Google (209 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 438-454-4545."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 438-454-4545.", "A question or an estimate? The fastest way: a call to 438-454-4545."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Supérieur recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 438-454-4545.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Supérieur, 1855, boulevard Industriel, Laval (Québec) H7S 1P5.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Supérieur collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 438-454-4545.\n\nPerson responsible for personal information: [name to be completed], Garage Supérieur, 1855, boulevard Industriel, Laval (Québec) H7S 1P5."),
