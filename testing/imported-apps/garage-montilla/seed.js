 ...
 * Dossier only (Google: address, phone, rating 4.6/127, 30+ years). Yellowpages 100262239 phone does not match: not used. Draft-to-confirm.
...
const SETTINGS = {
  business_name: "Garage Montilla",
  contact_phone: '438-869-9299',
  business_address: "8024, avenue Léonard-De Vinci, Montréal (Québec) H1Z 3R2",
  ...
  hero_title: J("Plus de 30 ans de mécanique.", "Over 30 years of auto repair."),
  hero_subtitle: J("Noté 4,6 sur 5 par 127 clients sur Google (septembre 2026), en affaires depuis plus de 30 ans. Demandez un rendez-vous en ligne : le garage vous rappelle pour fixer l’heure.", "Rated 4.6 out of 5 by 127 customers on Google (September 2026), in business for over 30 years. Request an appointment online: the garage calls you back to set the time."),
  ...
  about_text: J("Garage Montilla est un garage de mécanique automobile situé au 8024, avenue Léonard-De Vinci, à Montréal. Le garage est en affaires depuis plus de 30 ans. Ses clients lui donnent 4,6 sur 5 sur Google (127 avis, septembre 2026).\n\nPour connaître les heures d’ouverture ou faire vérifier votre véhicule, appelez le 438-869-9299.", "Garage Montilla is an auto repair shop at 8024, avenue Léonard-De Vinci in Montréal. The garage has been in business for over 30 years. Its customers rate it 4.6 out of 5 on Google (127 reviews, September 2026).\n\nTo check the opening hours or have your vehicle looked at, call 438-869-9299."),
  contact_intro: J("Une question ou une estimation? Le plus rapide : un coup de fil au 438-869-9299.", "A question or an estimate? The fastest way: a call to 438-869-9299."),
  privacy_notice: J("BROUILLON À APPROUVER PAR LE GARAGE\n\nGarage Montilla recueille votre nom, votre numéro de téléphone, votre adresse courriel et les renseignements sur votre véhicule uniquement pour gérer vos rendez-vous, vous joindre au sujet des travaux et tenir l’historique d’entretien de votre véhicule.\n\nCes renseignements sont conservés de façon sécurisée sur la plateforme Liasse, au Canada, et ne sont jamais vendus ni transmis à des tiers à des fins publicitaires.\n\nVous pouvez consulter, corriger ou supprimer vos renseignements en tout temps depuis votre compte ou en appelant le garage au 438-869-9299.\n\nResponsable de la protection des renseignements personnels : [nom à compléter], Garage Montilla, 8024, avenue Léonard-De Vinci, Montréal (Québec) H1Z 3R2.", "DRAFT FOR THE GARAGE TO APPROVE\n\nGarage Montilla collects your name, phone number, email address and vehicle details only to manage your appointments, reach you about the work and keep your vehicle’s service history.\n\nThis information is stored securely on the Liasse platform, in Canada, and is never sold or shared with third parties for advertising.\n\nYou can view, correct or delete your information at any time from your account or by calling the garage at 438-869-9299.\n\nPerson responsible for personal information: [name to be completed], Garage Montilla, 8024, avenue Léonard-De Vinci, Montréal (Québec) H1Z 3R2."),
