...
CREATE TABLE IF NOT EXISTS subscriptions (id SERIAL PRIMARY KEY, user_id INTEGER NOT NULL, plan_id INTEGER, order_id INTEGER, status TEXT DEFAULT 'active', starts_at TIMESTAMPTZ DEFAULT NOW(), expires_at TIMESTAMPTZ, m3u_url TEXT, credentials_username TEXT, credentials_password TEXT, firstaru_m3u_url TEXT, firstaru_credentials_username TEXT, firstaru_credentials_password TEXT, omega_m3u_url TEXT, omega_credentials_username TEXT, omega_credentials_password TEXT, edge_m3u_url TEXT, edge_credentials_username TEXT, edge_credentials_password TEXT, image_url TEXT, created_at TIMESTAMPTZ DEFAULT NOW(), updated_at TIMESTAMPTZ DEFAULT NOW());
