/**
 * PROPOSED service list — Mécanique EXCEL has not published its services anywhere we
 ...
 * confirms what the garage offers (Services et prix). Mécanique générale and Remorquage are confirmed: the garage’s own Google description says it is a general repair shop (cars, SUVs, trucks) with a towing service.
...
module.exports = [
  ...
  },
  {
    ...
    "body": "En panne à Longueuil ou dans les environs? Appelez directement le garage. Au moment de réserver, vous pouvez aussi indiquer que le véhicule doit être remorqué et l’adresse où il se trouve : le garage vous rappelle pour organiser la prise en charge.",
    "body_en": "Broken down in Longueuil or nearby? Call the garage directly. When booking, you can also say the vehicle needs a tow and where it is: the garage calls you back to arrange the pickup.",
