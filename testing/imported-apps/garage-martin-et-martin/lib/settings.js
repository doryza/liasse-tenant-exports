...
function urls(lang) {
  return lang === 'en' ? {
    ...
    account: 'en/my-account/', appointment: 'en/my-account/appointments/', lights: 'en/warning-lights/',
    about: 'en/the-garage/', contact: 'en/contact/', privacy: 'en/privacy/',
  } : {
    home: '.', services: 'services/', service: 'services/', booking: 'rendez-vous/',
    account: 'mon-compte/', appointment: 'mon-compte/rendez-vous/', lights: 'voyants/',
    about: 'le-garage/', contact: 'contact/', privacy: 'confidentialite/',
  };
}
...
module.exports = function (services) {
  ...
  async function init() {
    if (!initialized) initialized = (async () => {
      ...
      const defaults = { business_name: c.businessName || c.displayName || 'Garage Martin & Martin' };
