(function () {
  ...
  function renderTimes() {
    ...
    if (none) state.courtesyCar = false;
    // The courtesy-car and towing options are only rendered when the garage offers them.
    if (courtesy && cInput) {
      courtesy.classList.toggle('disabled', none); cInput.disabled = none; if (none) cInput.checked = false;
