(function () {
  ...
  var RULES = [
    { key: 'oil', every: 8000, fr: 'Vidange d’huile et filtre', en: 'Oil and filter change', slug: 'mecanique-generale', fromOil: true },
    { key: 'rotation', every: 10000, fr: 'Rotation des pneus', en: 'Tire rotation', slug: 'mecanique-generale' },
    { key: 'brakes', every: 20000, fr: 'Inspection des freins', en: 'Brake inspection', slug: 'freins' },
    { key: 'air', every: 24000, fr: 'Filtre à air du moteur', en: 'Engine air filter', slug: 'mecanique-generale' },
    { key: 'cabin', every: 24000, fr: 'Filtre d’habitacle', en: 'Cabin air filter', slug: 'mecanique-generale' },
    { key: 'trans', every: 80000, fr: 'Huile de transmission', en: 'Transmission fluid', slug: 'mecanique-generale' },
    { key: 'coolant', every: 160000, fr: 'Liquide de refroidissement', en: 'Engine coolant', slug: 'systeme-de-refroidissement' },
    { key: 'plugs', every: 160000, fr: 'Bougies d’allumage', en: 'Spark plugs', slug: 'mecanique-generale' },
  ];
