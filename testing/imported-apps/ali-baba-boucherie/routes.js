module.exports = function(services) {
  ...
  const T = {
    fr: {
      ...
      hero_title: 'Le goût du charbon de bois',
      hero_subtitle: 'Grillades libanaises sur charbon de bois à Blainville. Boucherie, brochettes taouk & kafta, filet mignon, côtelettes d\'agneau et tartares — préparés à la commande.',
      cta_menu: 'Voir le menu', cta_visit: 'Nous visiter',
      menu_title: 'Notre menu', menu_subtitle: "Des viandes fraîches de notre boucherie, marinées maison et grillées sur charbon de bois. Servies en assiette ou en sandwich, avec houmous, pita épicé et sauce à l'ail.",
      ...
      values_title: 'Notre feu',
      val1_t: 'Grillé sur charbon', val1_d: "Toutes nos viandes passent sur le charbon de bois — ce goût fumé qu'aucun gril ordinaire ne donne.",
      val2_t: 'Boucherie & grillades', val2_d: "Viandes fraîches de notre vitrine, marinées maison et grillées à la commande. Aussi offertes au kilo.",
      val3_t: 'Saveurs libanaises', val3_d: "Taouk, kafta, soujouk, makanek, tartares et pâtisseries orientales — la tradition dans l'assiette.",
      ...
      category_all: 'Tous',
      visit_title: 'Venez nous visiter', visit_subtitle: 'Notre boucherie-grillades vous accueille à Blainville. Suivez l\'odeur du charbon.',
    ...
    en: {
      ...
      hero_title: 'The Taste of Real Charcoal',
      hero_subtitle: 'Lebanese charcoal grill in Blainville. Butcher shop, taouk & kafta skewers, filet mignon, lamb chops and tartares — made to order.',
      cta_menu: 'See the menu', cta_visit: 'Visit us',
      menu_title: 'Our menu', menu_subtitle: 'Fresh meats from our butcher counter, house-marinated and grilled over wood charcoal. Served on a platter or in a sandwich, with hummus, spiced pita and garlic sauce.',
      ...
      values_title: 'Our fire',
      val1_t: 'Charcoal-grilled', val1_d: 'Every cut goes over wood charcoal — a smoky flavour no ordinary grill delivers.',
      val2_t: 'Butcher & grill', val2_d: "Fresh meats from our case, house-marinated and grilled to order. Also available by the kilo.",
      val3_t: 'Lebanese flavours', val3_d: 'Taouk, kafta, soujouk, makanek, tartares and Oriental pastries — tradition on the plate.',
      open_hours: 'Hours', address: 'Address', phone: 'Phone', email: 'Email',
      latest_news: 'Latest news', read_more: 'Read more',
      category_all: 'All',
      visit_title: 'Come visit us', visit_subtitle: 'Our butcher-grill welcomes you in Blainville. Just follow the charcoal smoke.',
  ...
  // Liasse Restaurants ordering-system export (Ali Baba Grillades, 2026-06-19).
  // The live source of truth for ordering is
  // https://ali-baba-boucherie.liasse.tech/order — the tenant menu_items
    ...
    "items": [
      {
        ...
        "price": 25.99,
        "category": "Assiettes",
        "description": "Poulet entier en crapaudine, grillé sur charbon de bois.",
      ...
      },
      {
        ...
        "price": 32,
        "category": "Assiettes",
        "description": "Taouk, kafta et filet mignon grillés sur charbon. Servi avec légumes grillés, pain pita épicé, houmous et sauce à l'ail. ½ kg ou 1 kg.",
      ...
      },
      {
        ...
        "price": 39,
        "category": "Assiettes",
        "description": "Bœuf tendre grillé sur charbon. Servi avec légumes grillés, pain pita épicé, houmous et sauce à l'ail. ½ kg ou 1 kg.",
      ...
      },
      {
        ...
        "price": 30,
        "category": "Assiettes",
        "description": "Bœuf haché, persil, oignon et épices, grillé sur charbon. Servi avec légumes grillés, pain pita épicé, houmous et sauce à l'ail. ½ kg ou 1 kg.",
      ...
      },
      {
        ...
        "price": 32,
        "category": "Assiettes",
        "description": "Poitrine de poulet marinée, grillée sur charbon. Servi avec légumes grillés, pain pita épicé, houmous et sauce à l'ail. ½ kg ou 1 kg.",
      ...
      },
      {
        ...
        "price": 32,
        "category": "Assiettes",
        "description": "Saucisses libanaises non piquantes, grillées sur charbon. Servi avec légumes grillés, pain pita épicé, houmous et sauce à l'ail. ½ kg ou 1 kg.",
      ...
      },
      {
        ...
        "price": 40,
        "category": "Assiettes",
        "description": "Côtelettes d'agneau grillées sur charbon. Servi avec légumes grillés, pain pita épicé, houmous et sauce à l'ail. ½ kg ou 1 kg.",
      ...
      },
      {
        ...
        "price": 32,
        "category": "Assiettes",
        "description": "Saucisses arméniennes piquantes, grillées sur charbon. Servi avec légumes grillés, pain pita épicé, houmous et sauce à l'ail. ½ kg ou 1 kg.",
      ...
      },
      {
        ...
        "price": 32,
        "category": "Assiettes",
        "description": "Saucisses marocaines non piquantes, grillées sur charbon. Servi avec légumes grillés, pain pita épicé, houmous et sauce à l'ail. ½ kg ou 1 kg.",
  ...
  const MENU_PREVIEW_CAT_EN = {"Entrées":"Starters","Sandwichs":"Sandwiches","Tartares":"Tartares","Assiettes":"Platters","Breuvages":"Drinks","Dessert":"Desserts"};
  ...
  async function sendTapContactUpsellEmail(visitor) {
    ...
    const appName = (services.config && services.config.displayName) || 'Ali Baba Grillades';
  ...
  async function fetchAppGooglePlaceId() {
    try {
      const slug = (services.config && services.config.slug) || 'ali-baba-boucherie';
  ...
  router.get('/', async function(req, res) {
    try {
      ...
      res.render('index', Object.assign(ctx, { platforms: platforms, preview: MENU_PREVIEW, previewCatEn: MENU_PREVIEW_CAT_EN }));
      ...
      modules: [
        {
          ...
          fields: [
            { name: 'name_fr', label: 'Nom (FR)', type: 'text', required: true, maxLength: 100, description: 'Nom du plat en français.', placeholder: 'ex. Brochette de taouk' },
            { name: 'name_en', label: 'Nom (EN)', type: 'text', required: false, maxLength: 100, description: 'Name in English (optional).', placeholder: 'e.g. Chicken Taouk Skewer' },
            { name: 'description_fr', label: 'Description (FR)', type: 'textarea', description: 'Description courte en français (1-2 phrases).', placeholder: 'ex. Poitrine de poulet marinée, grillée sur charbon, houmous et pita.' },
            { name: 'description_en', label: 'Description (EN)', type: 'textarea', description: 'English description (optional).', placeholder: 'e.g. Marinated chicken breast, charcoal-grilled, with hummus and pita.' },
        ...
        },
        {
          ...
          fields: [
            { name: 'title_fr', label: 'Titre (FR)', type: 'text', required: true, maxLength: 120, description: "Titre de l'offre en français.", placeholder: 'ex. Sandwich taouk + frites + boisson pour 16,99$' },
            { name: 'title_en', label: 'Titre (EN)', type: 'text', maxLength: 120, description: 'Title in English (optional).', placeholder: 'e.g. Taouk sandwich + fries + drink for $16.99' },
            { name: 'description_fr', label: 'Description (FR)', type: 'textarea', description: 'Détails de l\'offre en français.', placeholder: 'ex. Valide sur les assiettes grillées sur charbon.' },
...
function requireAdmin(req, res, next) {
  if (req.query.admin_token) {
    try {
      ...
      if (payload.admin === true && payload.slug === 'ali-baba-boucherie') {
        // Set self-verifying JWT cookie — works across all replicas without Redis
        try {
          var adminJwt = jwt.sign({ admin: true, slug: 'ali-baba-boucherie', userId: payload.userId || 0 }, services.jwtSecret, { expiresIn: '24h' });
          res.cookie('pwa_admin_ali-baba-boucherie', adminJwt, {
